...
![BGP ASN variables](images/task4-tfvars-bgp.png)
...
![XRd per-router variables](images/task4-tfvars-xrd.png)
...
![terraform init output](images/task4-tf-init-output.png)
...
![terraform apply confirmation prompt](images/task4-tf-apply-prompt.png)
...
![terraform plan no changes](images/task4-tf-plan-nochanges.png)
...
![terraform plan drift detection](images/task4-tf-plan-drift.png)
...
![terraform apply remediation](images/task4-tf-apply-remediate.png)
...
![terraform plan no changes after remediation](images/task4-tf-plan-nochanges2.png)
