...
> **New to Ansible?** The [Ansible Primer](Ansible-Primer.md) covers playbooks, plays, tasks, variables, and modules — everything you need before diving in here.
...
![vars block](images/task1-vars-block.png)
